...
public class MascotaAdaptadorFavorito extends RecyclerView.Adapter<MascotaAdaptadorFavorito.MascotaViewHolder> {
    ArrayList<Mascota> mascotas;

    public MascotaAdaptadorFavorito(ArrayList<Mascota> mascotas){
